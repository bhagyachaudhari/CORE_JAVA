    ...
    public static List<Integer> solve(List<Integer> A) {
        ...
        Collections.sort(A, new Comparator<Integer>(){
            ...
            public int compare(Integer x, Integer y){
                ...
                if(x == y){
                    if(org_x % 10 > org_y % 10)
                        return -1;
                    else if(org_x % 10 < org_y % 10)
                        return 1;
                }
                else if(org_x < org_y)
                    return -1;
